...
def get_throttling_function_name(js: str) -> str:
    ...
    function_patterns = [
        ...
        r'\b[a-zA-Z0-9$]{2}\s*&&\s*\([a-zA-Z0-9$]{2}\s*=\s*([a-zA-Z0-9$]{2})\(',
        r'\b[cs]\s*&&\s*d\.set\([^,]+,\s*(?P<name>[a-zA-Z0-9$]{2})\(',
        r'\b[cs]\s*&&\s*(?P<name>[a-zA-Z0-9$]{2})\(',
        r'\bc\s*&&\s*b\.set\([^,]+,\s*(?P<name>[a-zA-Z0-9$]{2})\(',
        r'\bc\s*&&\s*(?P<name>[a-zA-Z0-9$]{2})\(',
    ]
